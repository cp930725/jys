...
class Verify extends Controller
{
	...
	{
		$allow_action = array("code","code2","real","real1","regss","sendSms","mytx","paypass","pass","mibao","mobilebd","findpwd","findpaypwd","myzc","tests","findpwd_test");
...
/*	public function tests()
	...
	public function mytx()
	{
		...
		session('chkmobile',$mobile);
		$intnum = Db::name('User')->where(array('id' => userid()))->value('qz');
