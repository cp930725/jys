...
class AuthManager extends Admin
{
	...
	{
		$auth_group = Db::name('AuthGroup')->where('module', 'admin')->where('type', common\model\AuthGroup::TYPE_ADMIN)->find((int) $_GET['id']);
	...
	public function category()
	{
		...
		$authed_group = common\model\AuthGroup::getCategoryOfGroup(input('group_id'));
	...
	public function group()
	{
		...
		$user_groups = common\model\AuthGroup::getUserGroup($uid);
		$ids = array();
